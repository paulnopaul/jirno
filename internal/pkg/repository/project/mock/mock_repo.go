...
func (m *MockIProjectRepo) Create(arg0 domain.Project) error {
	m.ctrl.T.Helper()
...
func (m *MockIProjectRepo) GetByFilter(arg0 domain.ProjectFilter) ([]domain.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockIProjectRepo) GetByID(arg0 uuid.UUID) (*domain.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockIProjectRepo) Update(arg0 domain.ProjectUpdate) error {
	m.ctrl.T.Helper()
