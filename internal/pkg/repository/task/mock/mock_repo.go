...
func (m *MockITaskRepo) Create(arg0 domain.Task) error {
	m.ctrl.T.Helper()
...
func (m *MockITaskRepo) GetByFilter(arg0 domain.TaskFilter) ([]domain.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockITaskRepo) GetByID(arg0 uuid.UUID) (*domain.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockITaskRepo) Update(arg0 domain.TaskUpdate) error {
	m.ctrl.T.Helper()
